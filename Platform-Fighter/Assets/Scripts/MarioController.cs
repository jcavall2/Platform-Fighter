/*
    All controls for Player 1's Mario
*/
...
public class MarioController : MonoBehaviour
{
    ...
    NAME
        MarioController::Start() - Start is called before the first frame update

    Synopsis
        void MarioController::Start();

    Description
        Gets the components that are attached to the Mario game object and sets them to the variables made already
    ...
    */
    ...
    NAME
        MarioController::Update() - Update is called once per frame
    ...
    */
    ...
    private void Update()
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(attackTimer <= 0)
                    {
                        ...
                        //Makes Mario run to the left using the A key
                        if(Input.GetKey(KeyCode.A))
                        {
                            dirX = -1f;
                        }

                        //Makes Mario run to the right using the D key
                        else if(Input.GetKey(KeyCode.D))
                        {
                            dirX = 1f;
                        }
        ...
        else
        {
            ...
            else if (deathTimer < 3)
            {
                ...
                //Moves Mario to the top left part of the stage
    ...
    /**/
    /*
    MarioController::UpdateAnimation()

    NAME
        MarioController::UpdateAnimation() - Changes the animation Mario is in

    Synopsis
        void MarioController::UpdateAnimation(string attack);
    ...
    */
    ...
    /**/
    /*
    MarioController::IsOnGround()

    NAME
        MarioController::IsOnGround() - If Mario is on the ground

    Synopsis
        bool MarioController::IsOnGround();
    ...
    */
    ...
    NAME
        MarioController::KO() - checks if Mario has been knocked of the stage

    Synopsis
        void MarioController::KO();
    ...
    */
    ...
    NAME
        MarioController::Death() - Called once Mario is knocked far enough off stage to lose a stock

    Synopsis
        void MarioController::Death();
    ...
    Description
        ...
        Checks if Mario has 0 stocks and if so sets losingPlaying to player1 so the game can end.
    ...
    */
    ...
    private void Death()
    {
        ...
        //if Mario has run out of stocks make player1 the losing player
        if (stocks == 0)
        {
            PlayerPrefs.SetString("losingPlayer", "player1");
        }
    ...
    /**/
    /*
    MarioController::CheckAttack()

    NAME
        MarioController::CheckAttack() - Checks for what input the user did

    Synopsis
        void MarioController::CheckAttack();
    ...
    */
    ...
    private void CheckAttack()
    {
        ...
        if(IsOnGround())
        {
            //If the user presses V while holding down D or A, uses the forward smash attack
            if (Input.GetKeyDown(KeyCode.V) && (Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.A)))
            {
            ...
            //If the user presses V while holding down S, uses the down smash attack
            ...
            //If the user presses Z while holding down S, uses the down tilt attack
            ...
            //If the user presses V while holding down W, uses the up smash attack
            ...
            //If the user presses Z while holding down D or A, uses the side tilt attack
            if (Input.GetKeyDown(KeyCode.Z) && ((Input.GetKey(KeyCode.D)) || (Input.GetKey(KeyCode.A))))
            {
                //Sets dirX to 0 so Mario can't run while he attacks
                dirX = 0;
                inAnimation = true;
            ...
            //If the user presses Z while holding W, uses the up tilt attack
        ...
        if(!IsOnGround())
        {
            //If the user presses Z, while facing right and holding A or while facing left and pressing D
            if(Input.GetKeyDown(KeyCode.Z) && ((transform.localScale.x > 0 && Input.GetKey(KeyCode.A)) || (transform.localScale.x < 0 && Input.GetKey(KeyCode.D))))
            {
                inAnimation = true;
                inAerial = true;
            ...
            //If the user presses Z, while facing left and holding A or while facing to the right and pressing D
            else if (Input.GetKeyDown(KeyCode.Z) && ((transform.localScale.x < 0 && Input.GetKey(KeyCode.A)) || (transform.localScale.x > 0 && Input.GetKey(KeyCode.D))))
            {
                inAnimation = true;
                inAerial = true;
            ...
            //If the user presses Z, while holding S
            else if (Input.GetKeyDown(KeyCode.Z) && Input.GetKey(KeyCode.S))
            {
                inAnimation = true;
                inAerial = true;
            ...
            //If the user presses Z, while holding W
            else if (Input.GetKeyDown(KeyCode.Z) && Input.GetKey(KeyCode.W))
            {
                inAnimation = true;
                inAerial = true;
        ...
        //If the user presses X, while holding S
        ...
        //If the user presses X, while holding down W
        if (Input.GetKeyDown(KeyCode.X) && (Input.GetKey(KeyCode.W)))
        {
            //Makes Mario face to the right if also holding down D, since normally he doesn't turn around while in the air
            if(Input.GetKey(KeyCode.D))
            {
                transform.localScale = new Vector3(scale, scale, scale);
            }

            //Makes Mario face to the left if also holding down A, since normally he doesn't turn around while in the air
        ...
        {
            //If the user only pushes Z
            if (Input.GetKeyDown(KeyCode.Z))
            {
                //If the user presses Z again before the jab2 timer ends it uses jab3
                if(jab2Timer >= 0)
                {
                    inAnimation = true;
                ...
                //If the user presses Z again before the jab1 timer ends it uses jab2
                else if(jab1Timer >= 0)
                {
                    inAnimation = true;
                ...
                //The first time the user presses Z uses jab1
                else
                {
                    inAnimation = true;
    ...
    /**/
    /*
    MarioController::CheckAttackHit()

    NAME
        MarioController::CheckAttackHit() - Checks if the attack being used connects with the enemy

    Synopsis
        void MarioController::CheckAttackHit(string attack);
    ...
    */
    ...
    private void CheckAttackHit(string attack)
    {
        ...
        else
        {
            ...
            if(!enemyHit)
            {
                ...
                Collider2D hit = Physics2D.OverlapBox(attackUsed.bounds.center, attackUsed.bounds.extents, 0f, LayerMask.GetMask("Char2"));
    ...
    /**/
    /*
    MarioController::Knockback()

    NAME
        MarioController::Knockback() - Is called when the enemy hits Mario

    Synopsis
        void MarioController::Knockback(Vector4 knockInfo);
    ...
    */
    ...
    /**/
    /*
    MarioController::PlaySound()

    NAME
        MarioController::PlaySound() - Plays the sound clip that is passed to it

    Synopsis
        void MarioController::PlaySound(AudioClip clip);
